...
class TestComments(unittest.TestCase):
    ...
    def setUp(self):
        self.user_dean=Users(username='rustique',password='uwimpaye12',email='rustique644@gmail.com')
        self.new_comment=Comments(email="dean@gmail.com",username="user",comment="dope",blog_id=20)
    ...
    def test_check_instance_variables(self):
        self.assertEquals(self.new_comment.email,"dean@gmail.com")
